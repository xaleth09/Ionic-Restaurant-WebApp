angular.module('conFusion.controllers', [])
  ...
  .controller('IndexController', ['$scope', 'dish', 'lead', 'promo', 'baseURL', function($scope, dish, lead, promo, baseURL) {
  ...
  .controller('DishDetailController', ['$scope', '$stateParams', 'dish', 'menuFactory', 'favoriteFactory', 'baseURL', '$ionicPopover',
    ...
    function($scope, $stateParams, dish, menuFactory, favoriteFactory, baseURL, $ionicPopover, $ionicModal, $ionicListDelegate,
      ...
      $scope.addComment = function() {
        console.log('Adding Comment', $scope.additionalComment);
        $scope.additionalComment.date = new Date().toISOString();
        $scope.dish.comments.push($scope.additionalComment);
